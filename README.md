...
Passionné de programmation et d'informatique en général. Je fais tout mon possible pour réaliser mes rêves 😁 je suis actuellement une formation intensive de 9 mois en développement .NET chez **Technifutur** (Liège, Belgique 🇧🇪).

---

## Stack Technique & Compétences

### Back-End & Écosystème .NET
![.NET](https://img.shields.io/badge/.NET-512BD4?style=flat)
![C#](https://img.shields.io/badge/C%23-239120?style=flat&logo=c-sharp&logoColor=white)

- **Frameworks & ORM :** ASP.NET Core, Entity Framework Core, ADO.NET
- **Architecture & Design :** Clean Architecture, DDD, CQRS, Principes SOLID
- **Technologies web & desktop :** Blazor, MAUI 
...
![RxJS](https://img.shields.io/badge/RxJS-B20062?style=flat&logo=reactivex&logoColor=white)
